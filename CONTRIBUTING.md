...
Thanks for your interest in contributing to `trustedagents` — Pilot Protocol trusted-agents plugin — embedded auto-trust allowlist + IsTrusted() gate.

## Quick start

```bash
git clone https://github.com/pilot-protocol/trustedagents.git
cd trustedagents
go test -race ./...
```
